              ...
              <li class="nav-item dropdown dropdown-hover mx-2">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages">
                  <div class="d-none d-lg-block">
                    ...
                    <a href="{{ asset('assets/pages/about-us.html') }}" class="dropdown-item border-radius-md">
                      <span class="ps-3">About Us</span>
                    </a>
                    <a href="{{ asset('assets/pages/contact-us.html') }}" class="dropdown-item border-radius-md">
                      <span class="ps-3">Contact Us</span>
                    </a>
                    <a href="{{ asset('assets/pages/author.html') }}" class="dropdown-item border-radius-md">
                    ...
                    <a href="{{ asset('assets/pages/sign-in.html') }}" class="dropdown-item border-radius-md">
                ...
                <ul class="dropdown-menu dropdown-menu-animation dropdown-lg dropdown-lg-responsive p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuBlocks">
                  <div class="d-none d-lg-block">
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                      <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ asset('assets/presentation.html') }}">
                        <div class="d-flex">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/page-sections/hero-sections.html') }}">
                          Page Headers
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/page-sections/features.html') }}">
                          Features
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/navigation/navbars.html') }}">
                          Navbars
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/navigation/nav-tabs.html') }}">
                          Nav Tabs
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/navigation/pagination.html') }}">
                          Pagination
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/input-areas/inputs.html') }}">
                          Inputs
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/input-areas/forms.html') }}">
                          Forms
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/attention-catchers/alerts.html') }}">
                          Alerts
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/attention-catchers/modals.html') }}">
                          Modals
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/attention-catchers/tooltips-popovers.html') }}">
                          Tooltips & Popovers
                        </a>
                      </div>
                    </li>
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem">
                      ...
                      <div class="dropdown-menu mt-0 py-3 px-2 mt-3">
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/avatars.html') }}">
                          Avatars
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/badges.html') }}">
                          Badges
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/breadcrumbs.html') }}">
                          Breadcrumbs
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/buttons.html') }}">
                          Buttons
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/dropdowns.html') }}">
                          Dropdowns
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/progress-bars.html') }}">
                          Progress Bars
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/toggles.html') }}">
                          Toggles
                        </a>
                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ asset('assets/sections/elements/typography.html') }}">
                          Typography
                        </a>
                      </div>
                    </li>
                ...
                <ul class="dropdown-menu dropdown-menu-animation dropdown-lg mt-0 mt-lg-3 p-3 border-radius-lg" aria-labelledby="dropdownMenuDocs">
                  <div class="d-none d-lg-block">
                    <ul class="list-group">
                      <li class="nav-item list-group-item border-0 p-0">
                        <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ asset('assetsttps://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-design-system') }}">
                          <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                      ...
                      <li class="nav-item list-group-item border-0 p-0">
                        <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ asset('assets') }}">
                          <div class="d-flex">
                            <div class="icon h-10 me-3 d-flex mt-1">
                  ...
                  <div class="row d-lg-none">
                    <div class="col-md-12 g-0">
                      <a class="dropdown-item py-2 ps-3 border-radius-md" href="{{ asset('assets/pages/about-us.html') }}">
                        <div class="d-flex">
                          <div class="icon h-10 me-3 d-flex mt-1">
                            <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                              <title>spaceship</title>
